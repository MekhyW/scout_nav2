...
def generate_launch_description(): 
	...
	return LaunchDescription(
		[
			...
			IncludeLaunchDescription(PythonLaunchDescriptionSource([get_package_share_directory("aws_robomaker_small_warehouse_world"), "/launch/no_roof_small_warehouse.launch.py",])),
